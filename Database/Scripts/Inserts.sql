...
BEGIN
    ...
    inserir_perfil(3, 'João Lima', 'Rua C, 789', '11999999977', '11888888866');
...
BEGIN
    inserir_localizacao(-23.55, -46.63, 'Centro', 'São Paulo', 'SP', '01000-000');
